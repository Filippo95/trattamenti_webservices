...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr> <td>" . $row["id"]. "</td><td>" . $row["nome"]. "</td><td>" . $row["principio_attivo"]. "</td><td>" . $row["prezzo_fattura"]. "</td><td>" . $row["sconto"]. "</td><td>" . $row["Q_consumata"]. "</td><td>" . $row["Q_caricata"]. "</td><td>" . $row["Giacenza"]. "</td><td>" . $row["stima"]. "</td></tr>";
    }
} else {
    echo "0 results";
}
